      ...
      <div className={styles['page-like']}>
        ...
        <main className={styles['main']}>
          <header>
            ...
            <p className={styles['subtitle']}>Start turning plastic wastes to CRYPTO</p>
          </header>

          <section className={styles['content']}>
            <form action="">
            <label className={styles['input-label']} htmlFor="name">Full name&#42;</label>
            <input className={styles['input-elem']} type="text" placeholder='Enter your full name here' id='name'/>
          ...
          <p 
            className={styles['texty']}>Already have an account? 
